...
const Resume = () => {
    return (
        <main className="flex flex-col justify-evenly items-center w-screen px-14 py-8 pt-28 h-screen sm:h-fit">
            ...
            <div className="h-80 sm:h-152 w-11/12 my-10 rounded border-8 border-gun-metal dark:border-ghost-white">
